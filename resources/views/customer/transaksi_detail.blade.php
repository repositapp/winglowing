                                ...
                                <div class="table-content table-responsive">
                                    <table class="table">
                                        <thead class="mt-whislist-header">
                                            <tr>
                                                <th class="product-thumbnail">Kode Produk</th>
                                            ...
                                            @foreach ($transaksi->details as $index => $detail)
                                                <tr>
                                                    ...
                                                    <td class="mt-whislist-price">
                                                        <span class="amount">{{ $detail->produk->discount }}%</span>
                                                    </td>
                                                    <td class="mt-whislist-price">
                                                        <span class="amount">{{ $detail->qty }}</span>
                                                    </td>
                                                    <td class="mt-whislist-price">
                                                        <span
                                                            class="amount">Rp{{ number_format($detail->produk->price, 0, ',', '.') }}</span>
                                                    </td>
                                                    <td class="mt-whislist-price">
                                                        <span
                                                            class="amount">Rp{{ number_format($detail->subtotal, 0, ',', '.') }}</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
