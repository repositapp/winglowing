...
@section('content')
    ...
    <section class="content">
        <div class="box box-success">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="{{ route('rekening.update', $bank->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nama_bank') is-invalid @enderror"
                                id="nama_bank" name="nama_bank" value="{{ old('nama_bank', $bank->nama_bank) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('rekening') is-invalid @enderror"
                                id="rekening" name="rekening" value="{{ old('rekening', $bank->rekening) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('pemilik') is-invalid @enderror" id="pemilik"
                                name="pemilik" value="{{ old('pemilik', $bank->pemilik) }}" placeholder="Pemilik">
                            @error('pemilik')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            @if ($bank->logo_bank)
                                <img src="{{ asset('storage/' . $bank->logo_bank) }}"
                                    class="img-fluid mb-3 col-sm-3 d-block" alt="Logo Bank">
                            @else
